...
| Herdr                           | [reference](https://herdr.dev/docs/configuration/#theme)                                           | [neon](herdr/silkcircuit-neon.toml) · [vibrant](herdr/silkcircuit-vibrant.toml) · [soft](herdr/silkcircuit-soft.toml) · [glow](herdr/silkcircuit-glow.toml) · [dawn](herdr/silkcircuit-dawn.toml)                                                        |
| Herdr (auto light/dark)         | [reference](https://herdr.dev/docs/configuration/#theme)                                           | [every variant](herdr/silkcircuit.toml)                                                                                                                                                                                                                  |
...
cp herdr/silkcircuit-*.toml ~/.config/herdr/                  # merge the [theme] tables into config.toml
