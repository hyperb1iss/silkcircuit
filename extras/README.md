...
| GNU dircolors                   | [reference](https://www.gnu.org/software/coreutils/manual/html_node/dircolors-invocation.html)     | [neon](dircolors/silkcircuit-neon.dircolors) · [vibrant](dircolors/silkcircuit-vibrant.dircolors) · [soft](dircolors/silkcircuit-soft.dircolors) · [glow](dircolors/silkcircuit-glow.dircolors) · [dawn](dircolors/silkcircuit-dawn.dircolors)           |
